...
public class JobItemBiz
{
	...
	public List<JobItem> getJobItems(int cursor, int catId, int areaId) throws CommonException
	{
		...
		//Element masthead = doc.getElementsByClass("content").first();
		Log.i("wwwwww",htmlStr);
		Log.w("zzzz",doc.toString());
		Elements pts = doc.select("div.pt");
